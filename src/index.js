 ...
 * @LastEditTime: 2020-11-08 00:35:51
...
export class Picker extends PureComponent {
  ...
  componentDidMount() {
    const {dataSourse} = this.props;
    if (!dataSourse || !this.props.dataSourse.length) {
      console.warn('SlidePicker: dataSource should be a array');
      return;
    } else {
      this.splitData(dataSourse);
    }
  }
  ...
  setL2List = proId => {
    ...
    const pros = this.props.dataSourse;
